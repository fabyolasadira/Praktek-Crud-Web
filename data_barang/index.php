...
<form method="get" class="mb-3">
    ...
    <button class="btn btn-secondary">Cari/Filter</button>
</form>

<a href="tambah.php" class="btn btn-warning mb-2">+ Tambah Barang</a>
<a href="export_excel.php" class="btn btn-success mb-2">Export ke Excel</a>

<table class="table table-bordered">
    <tr>
        <th>Nama</th><th>Kategori</th><th>Stok</th><th>Harga</th><th>Tanggal</th><th>Aksi</th>
    </tr>
    ...
    <tr>
        ...
        <td>
            <a href="edit.php?id=<?= $d['id_barang'] ?>" class="btn btn-secondary btn-sm">Edit</a>
